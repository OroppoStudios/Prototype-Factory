...
namespace FIMSpace.AnimationTools.CustomModules
{
    ...
    public class ADModule_CustomCurve : ADCustomModuleBase
    {
        ...
        public override void OnExportFinalizing(AnimationClip originalClip, AnimationClip newGeneratedClip, AnimationDesignerSave s, ADClipSettings_Main anim_MainSet, ADClipSettings_CustomModules customModules, ADClipSettings_CustomModules.CustomModuleSet set)
        {
            base.OnExportFinalizing(originalClip, newGeneratedClip, s, anim_MainSet, customModules, set);
